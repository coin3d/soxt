...
class SoXtSlider {
public:
  SoXtSlider( const Widget parent, SoXtSliderManager * const manager );
  ~SoXtSlider(void);
...
protected:
  void layoutSimple(void) const;
  void layoutRanged(void) const;
  void layoutFull(void) const;
  void layoutOrderly(void) const;
...
private:
  ...
  SoXtSliderManager * const manager;
